...
set jsCommon= -O0 -s WASM=0 %commonFlags% -s SINGLE_FILE=1 -s TEXTDECODER=0 -s MIN_IE_VERSION=11 -s INCOMING_MODULE_JS_API=['preRun','noInitialRun'] -s LEGACY_VM_SUPPORT=1 -s ENVIRONMENT='worker' --closure 1 --memory-init-file 0
