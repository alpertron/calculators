...
// See http://www.alpertron.com.ar/SUMCUAD.HTM
//
...
public final class sumcuad extends Applet implements Runnable {
  ...
  public void init() {
    ...
    add(lowerTextArea);
    labelBottom = new Label("Escrito por Dario Alejandro Alpern. Modificado el 20 de diciembre de 2002");
  ...
  public void run() {
    ...
    try {
      ...
      if (ExpressionRC != 0) {
        switch (ExpressionRC) {
        case -1:
          lowerTextArea.setText("Número muy pequeño (menor que 2).");
          break;
        case -2:
    ...
    else
    {
      ...
      else
      {
        ...
        {
          lowerTextArea.setText("Calculando suma de tres cuadrados...");
        ...
        else
        {
          iMult3 = -1;
          iMult4 = 0;
          lowerTextArea.setText("Calculando suma de cuatro cuadrados...");
...
compute_squares_loop:
    ...
    paneFooter = "\n\n"+timeElapsed+
                 "\n\nCantidad de exponenciaciones modulares: "+nbrModExp;
    ShowPane();
  }
