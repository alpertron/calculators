...
set commonOptions=-Os -Wall -s WASM=0 -s TEXTDECODER=0 -s MIN_IE_VERSION=11 -s ASSERTIONS=0 -s NO_FILESYSTEM=1 --closure 1 --js-library lib.js --pre-js pre.js --memory-init-file 0
set wasmCommon=-Os -Wall -s WASM=1 -D_USING64BITS_ -flto -s ASSERTIONS=0 -s NO_FILESYSTEM=1 --js-library lib.js --pre-js pre.js
if "%1" == "" goto :end
del *.wasm
del *00*js

rem ==================== GENERATION OF ASM.JS ===============================
rem set PATH=%PATH:C:\Users\dario\emsdk\emsdk\upstream\emscripten;=%
rem call emsdk activate latest-fastcomp > NUL
...
rem set PATH=%PATH:C:\Users\dario\emsdk\emsdk\fastcomp\emscripten;=%
rem call emsdk activate latest > NUL
